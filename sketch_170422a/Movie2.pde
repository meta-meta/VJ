...
public class Movie2 extends Movie {
  ...
  public void jump(float where) {
    ...
    res = playbin.seek(rate, org.gstreamer.Format.TIME, org.gstreamer.SeekFlags.KEY_UNIT, 
    ...
    //    boolean res = playbin.seek(rate, org.gstreamer.Format.TIME, org.gstreamer.SeekFlags.KEY_UNIT, 
    //      org.gstreamer.SeekType.SET, pos, org.gstreamer.SeekType.NONE, -1);
    //    if (!res) {
    //      PGraphics.showWarning("Seek operation failed.");
    //    }
