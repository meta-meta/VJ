...
//        Rect newPos = new Rect(1680, 0 - tabHeight, Screen.currentResolution.width, Screen.currentResolution.height + tabHeight);
        Rect newPos = new Rect(1680, 0 - tabHeight, 1281, 1024 + tabHeight);

        gameView.position = newPos;
//        gameView.minSize = new Vector2(Screen.currentResolution.width, Screen.currentResolution.height + tabHeight);
        gameView.minSize = new Vector2(1281, 1024 + tabHeight);
